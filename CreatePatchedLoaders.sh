...
${ADS_TOOLCHAIN_BIN_DIR}/tcc -apcs /interwork -O2 Injection_RQRC_Dump_RAM.c -c patch_ram.o
...
${ADS_TOOLCHAIN_BIN_DIR}/tcc -apcs /interwork -O2 Injection_RQRC_Dump_NAND.c -c patch_nand.o
