...
${ADS_TOOLCHAIN_BIN_DIR}/armcc -apcs /interwork -O2 Injection_RQRC_Dump_SRAM.c -c -o patch_sram.o
${ADS_TOOLCHAIN_BIN_DIR}/armlink -ro-base 0x0034E160 patch_sram.o QA30_RAMDLD_0206.sym -o patch_sram.elf
...
#${ADS_TOOLCHAIN_BIN_DIR}/armlink -ro-base 0x0013B430 patch_nand.o QA30_RAMDLD_0206.sym -o patch_nand.elf
