...
${ADS_TOOLCHAIN_BIN_DIR}/armlink -ro-base 0x0013B430 patch_sram.o ../syms/V9m_RAMDLD_01B5.sym -o patch_sram.elf
...
${ADS_TOOLCHAIN_BIN_DIR}/armlink -ro-base 0x0013B430 patch_nand.o ../syms/V9m_RAMDLD_01B5.sym -o patch_nand.elf
