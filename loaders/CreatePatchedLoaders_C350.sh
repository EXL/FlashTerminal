...
python3 -c "with open('patch_nor.bin','rb') as i,open('C350_RAMDLD_0372_Patched_Dump_NOR.bin','r+b') as o: o.seek(0x40);o.write(i.read())"

# Add branch patch.
python3 -c "with open('C350_RAMDLD_0372_Patched_Dump_NOR.bin','r+b') as f: f.seek(0x10776);f.write(b'\xF7\xEF\xFC\x63')"
