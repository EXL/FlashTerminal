...
${ADS_TOOLCHAIN_BIN_DIR}/armlink -ro-base 0x01010704 patch_nor.o ../syms/V120e_RAMDLD_0713.sym -o patch_nor.elf
...
# Insert patch to 0x704 offset.
python3 -c "with open('patch_nor.bin','rb') as i,open('V120e_RAMDLD_0713_Patched_Dump_NOR.ldr','r+b') as o: o.seek(0x704);o.write(i.read())"
