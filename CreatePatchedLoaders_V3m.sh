...
${ADS_TOOLCHAIN_BIN_DIR}/armlink -ro-base 0x00133D90 patch_sram.o V3m_RAMDLD_010C.sym -o patch_sram.elf
...
${ADS_TOOLCHAIN_BIN_DIR}/armlink -ro-base 0x00133D90 patch_nand.o V3m_RAMDLD_010C.sym -o patch_nand.elf
